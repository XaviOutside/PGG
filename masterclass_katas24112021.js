...
/* exercici 3: defineix una funció pregunta() que et pregunti "T'agrada la pizza?" quan li introduim com 
a paràmentre "la pizza" */

function pregunta(_param) {

    console.log("T'agrada " + _param + "?");
}
pregunta("la pizza");

/* exercici 4: defineix una funció pregunta2() que et retorni "T'agrada la pizza" quan li introduim 
com a paràmentre "la pizza"*/

function pregunta2(_param) {
    return ("T'agrada " + _param);
}
console.log(pregunta2("la pizza") + " amb piña?");

/* exercici 5: defineix una funció metresCubicsALitres() que passi metres cúbics a litres i retorni el 
resultat i una altra mostrarSolució() que usi la primera per mostrar per la consola "X metres cúbics
 són Y litres"*/
...
function mostrarSolució() {
    metresCubicsALitres();
    console.log(m3 + " metres cúbics són " + metresCubicsALitres() + " litres.")
}
mostrarSolució();


/* exercici 6: defineix dues funcions afegirDiners() i gastarDiners() que sumi/resti a una variable externa 
el valor indicat al paràmetre i mostri a la consola la quantitat actual de diners */

var diners = 0;

function afegirDiners(param) {
    diners = diners + param;
}

function gastarDiners(param) {
    diners = diners - param;
...
/* exercici 7: fes un diàleg que et demani la talla de samarreta que vols comprar (S, M, L, XL) i 
et digui per la consola quina talla has sel·leccionat i t'avisi si sel·lecciones una talla que no és 
vàlida */

var talla = prompt("Quina talla vols (S, M, L, XL) ?")
